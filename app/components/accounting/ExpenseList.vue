...
<template>
  <UCard>
    <template #header>
      <div class="flex items-center justify-between">
        <h3 class="font-semibold">
          {{ t("accounting.expenses.expenseList") }}
        </h3>
        <UButton
          variant="outline"
      ...
      >
        <div class="flex items-center gap-4">
          <div
            ...
            :style="{
              backgroundColor:
                expensesStore.getCategoryInfo(expense.category).color + '20',
            }"
          >
            <UIcon
              ...
              class="text-xl"
              :style="{
                color: expensesStore.getCategoryInfo(expense.category).color,
              }"
            />
          </div>
          <div>
        ...
        <div class="flex items-center gap-4">
          <div class="text-right">
            ...
            <p class="text-xs text-muted">
              {{
                t(`accounting.expenses.paymentMethods.${expense.paymentMethod}`)
              }}
            </p>
          </div>
    ...
    <div
      ...
      class="flex justify-between items-center mt-4 pt-4 border-slate-100 dark:border-slate-800 border-t"
    >
      <p class="text-sm text-muted">
        {{
          t("accounting.expenses.showing", {
