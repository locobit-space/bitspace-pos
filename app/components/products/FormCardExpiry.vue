...
<template>
  ...
  >
    ...
    <div class="p-6 space-y-4">
      ...
      >
        <div class="flex items-center gap-3">
          <UIcon name="solar:calendar-linear" class="w-5 h-5 text-gray-500" />
          <div>
      ...
      <template v-if="form.hasExpiry">
        ...
        <div class="grid grid-cols-2 gap-4 pt-2">
          <UFormField
            :label="t('products.defaultShelfLifeDays', 'Shelf Life (days)')"
          ...
          <UFormField
            :label="t('products.expiryWarningDays', 'Warning Before (days)')"
        ...
        <!-- Storage Type -->
        <UFormField
          :label="t('products.storageType', 'Storage Type')"
          name="storageType"
        >
          <USelect
            ...
            value-key="value"
            :placeholder="
              t('products.selectStorageType', 'Select storage type')
            "
          />
        </UFormField>
      </template>
