...
const getPercentage = (amount: number): number => {
  return props.kpis.totalRevenue > 0
    ? (amount / props.kpis.totalRevenue) * 100
    : 0;
};
</script>
...
<template>
  <div
    class="h-full bg-white dark:bg-gray-900 rounded-lg p-4 border border-gray-200 dark:border-gray-800"
  >
    <h3 class="font-medium text-gray-900 dark:text-white text-sm mb-3">
    ...
    <div class="space-y-3">
      ...
      <div class="flex items-center gap-2">
        <div
          class="w-7 h-7 rounded-lg bg-green-100 dark:bg-green-900/30 flex items-center justify-center"
        >
          <UIcon
            name="solar:banknote-linear"
        ...
        <div class="flex-1">
          ...
          <div
            class="h-1 bg-gray-100 dark:bg-gray-700 rounded-full overflow-hidden"
          >
            <div
      ...
      <div class="flex items-center gap-2">
        ...
        <div class="flex-1">
          <div class="flex justify-between items-center mb-0.5">
            <span class="text-xs text-gray-600 dark:text-gray-300">{{
              t("payment.methods.lightning")
            }}</span>
            <span
              class="font-medium text-amber-600 dark:text-amber-400 tabular-nums text-sm"
            >
      ...
      <div v-if="kpis.otherSales > 0" class="flex items-center gap-2">
        <div
          class="w-7 h-7 rounded-lg bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center"
        >
          <UIcon
            name="solar:smartphone-linear"
