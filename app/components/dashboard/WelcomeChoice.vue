                ...
                <button type="button"
                    ...
                    <div class="flex items-center gap-4 mb-4">
                        <div
                            ...
                            <UIcon name="i-heroicons-user-group" class="w-7 h-7 text-green-600" />
                        </div>
                        <div>
                    ...
                    <p class="text-gray-600 dark:text-gray-400 text-sm">
                        {{ t("shop.welcome.joinDescription") || "Enter company code to connect and sync data" }}
                    </p>
                </button>
                ...
                <button type="button"
                    ...
                    <div class="flex items-center gap-4 mb-4">
                        <div
                            ...
                            <UIcon name="i-heroicons-building-storefront" class="w-7 h-7 text-primary-600" />
                        </div>
                        <div>
                            <h3 class="text-xl font-bold text-gray-900 dark:text-white">
                    ...
                    <p class="text-gray-600 dark:text-gray-400 text-sm">
                        {{ t("shop.welcome.createDescription") || "Set up your shop and get a code for staff" }}
                    </p>
                </button>
            </div>
                ...
                <div v-if="selectedMode === 'join'" class="mt-6">
                    <UCard>
                        <div class="space-y-4">
                            ...
                            <UInput v-model="companyCodeInput" :placeholder="'XXXX-XXXX-XXXX'" size="xl"
                                class="text-center font-mono text-xl tracking-widest" icon="i-heroicons-key"
                            ...
                            <UButton block size="lg" color="green" :loading="isConnecting" :disabled="!isValidCode"
                ...
                <div v-if="selectedMode === 'create'" class="mt-6">
                    <UCard>
                        <div class="space-y-4">
                            ...
                            <UButton block size="lg" color="primary" @click="handleCreateCompany">
...
// Computed
const isValidCode = computed(() => company.isValidCompanyCode(companyCodeInput.value));
...
async function handleJoinCompany() {
    ...
    try {
        ...
        try {
            ...
            console.log("[WelcomeChoice] Discovered owner pubkey:", ownerPubkey?.slice(0, 8) + "...");
        } catch (e) {
