    ...
    if (result.error === "coupon.errors.minOrder") {
      ...
      if (coupon?.minOrderAmount) {
        error.value = t(result.error, {
          amount: currencyHelper.format(coupon.minOrderAmount, props.currency),
        });
      } else {
        error.value = t(result.error);
      }
  ...
  <div class="space-y-2">
    ...
    >
      <div class="flex items-center gap-3">
        ...
        >
          <UIcon name="solar:ticket-linear" class="w-6 h-6 text-green-600" />
        </div>
        <div class="text-left">
      ...
      <div class="flex items-center gap-2">
        ...
        <button
          ...
          @click="removeCoupon"
        >
          <UIcon name="solar:close-circle-linear" class="w-4 h-4" />
        </button>
      </div>
    </div>
    ...
    <div v-else>
      ...
      >
        ...
        >
          <UIcon name="solar:ticket-linear" class="w-4 h-4" />
