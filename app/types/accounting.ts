...
export const LAO_CHART_OF_ACCOUNTS: Omit<Account, "createdAt" | "updatedAt">[] =
  [
    ...
    {
      code: "4400",
      name: "Room/Table Revenue",
      nameLao: "ລາຍຮັບຫ້ອງ/ໂຕະ",
      type: "revenue",
      isActive: true,
      isSystem: false,
      normalBalance: "credit",
...
export const GLOBAL_CHART_OF_ACCOUNTS: Omit<
  Account,
  "createdAt" | "updatedAt"
>[] = [
  // ASSETS (10000-19999)
