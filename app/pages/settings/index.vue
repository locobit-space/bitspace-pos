  ...
  <div class="p-4 space-y-4">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
      <NuxtLink to="/settings/general" class="block">
        <div class="h-full bg-white dark:bg-gray-900 rounded-lg p-4 border border-gray-200 dark:border-gray-800 hover:border-primary-300 dark:hover:border-primary-700 transition-colors">
          <div class="flex items-center gap-3">
            <div class="w-10 h-10 rounded-lg bg-gray-100 dark:bg-gray-800 flex items-center justify-center">
              <UIcon name="i-heroicons-building-storefront" class="w-5 h-5 text-gray-600 dark:text-gray-400" />
            </div>
            <div>
      ...
      <NuxtLink to="/settings/lightning" class="block">
        <div class="h-full bg-white dark:bg-gray-900 rounded-lg p-4 border border-gray-200 dark:border-gray-800 hover:border-amber-300 dark:hover:border-amber-700 transition-colors">
          <div class="flex items-center gap-3">
      ...
      <NuxtLink to="/settings/users" class="block">
        <div class="h-full bg-white dark:bg-gray-900 rounded-lg p-4 border border-gray-200 dark:border-gray-800 hover:border-blue-300 dark:hover:border-blue-700 transition-colors">
          <div class="flex items-center gap-3">
      ...
      <NuxtLink to="/settings/account" class="block">
        <div class="h-full bg-white dark:bg-gray-900 rounded-lg p-4 border border-gray-200 dark:border-gray-800 hover:border-purple-300 dark:hover:border-purple-700 transition-colors">
          <div class="flex items-center gap-3">
            <div class="w-10 h-10 rounded-lg bg-purple-100 dark:bg-purple-900/30 flex items-center justify-center">
              <UIcon name="i-heroicons-user-circle" class="w-5 h-5 text-purple-600 dark:text-purple-400" />
            </div>
            <div>
              <h3 class="font-medium text-gray-900 dark:text-white text-sm">
    ...
    <!-- Business Settings -->
    <div>
      <h2 class="text-sm font-medium text-gray-500 dark:text-gray-400 mb-3">Business</h2>
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
        <NuxtLink to="/settings/tax" class="block">
          <div class="h-full bg-white dark:bg-gray-900 rounded-lg p-4 border border-gray-200 dark:border-gray-800 hover:border-green-300 dark:hover:border-green-700 transition-colors">
            <div class="flex items-center gap-3">
              <div class="w-10 h-10 rounded-lg bg-green-100 dark:bg-green-900/30 flex items-center justify-center">
                <UIcon name="i-heroicons-receipt-percent" class="w-5 h-5 text-green-600 dark:text-green-400" />
              </div>
              <div>
                <h3 class="font-medium text-gray-900 dark:text-white text-sm">
        ...
        <NuxtLink to="/settings/receipt" class="block">
          <div class="h-full bg-white dark:bg-gray-900 rounded-lg p-4 border border-gray-200 dark:border-gray-800 hover:border-indigo-300 dark:hover:border-indigo-700 transition-colors">
            <div class="flex items-center gap-3">
        ...
        <NuxtLink to="/products/meta" class="block">
          <div class="h-full bg-white dark:bg-gray-900 rounded-lg p-4 border border-gray-200 dark:border-gray-800 hover:border-orange-300 dark:hover:border-orange-700 transition-colors">
            <div class="flex items-center gap-3">
              <div class="w-10 h-10 rounded-lg bg-orange-100 dark:bg-orange-900/30 flex items-center justify-center">
                <UIcon name="i-heroicons-tag" class="w-5 h-5 text-orange-600 dark:text-orange-400" />
              </div>
              <div>
                <h3 class="font-medium text-gray-900 dark:text-white text-sm">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
        <NuxtLink to="/settings/backup" class="block">
          <div class="h-full bg-white dark:bg-gray-900 rounded-lg p-4 border border-gray-200 dark:border-gray-800 hover:border-cyan-300 dark:hover:border-cyan-700 transition-colors">
            <div class="flex items-center gap-3">
              <div class="w-10 h-10 rounded-lg bg-cyan-100 dark:bg-cyan-900/30 flex items-center justify-center">
                <UIcon name="i-heroicons-cloud-arrow-up" class="w-5 h-5 text-cyan-600 dark:text-cyan-400" />
              </div>
              <div>
                <h3 class="font-medium text-gray-900 dark:text-white text-sm">
        ...
        <NuxtLink to="/settings/audit-log" class="block">
          <div class="h-full bg-white dark:bg-gray-900 rounded-lg p-4 border border-gray-200 dark:border-gray-800 hover:border-rose-300 dark:hover:border-rose-700 transition-colors">
            <div class="flex items-center gap-3">
              <div class="w-10 h-10 rounded-lg bg-rose-100 dark:bg-rose-900/30 flex items-center justify-center">
                <UIcon name="i-heroicons-shield-check" class="w-5 h-5 text-rose-600 dark:text-rose-400" />
              </div>
              <div>
                <h3 class="font-medium text-gray-900 dark:text-white text-sm">
        ...
        <NuxtLink to="/settings/relays" class="block">
          <div class="h-full bg-white dark:bg-gray-900 rounded-lg p-4 border border-gray-200 dark:border-gray-800 hover:border-violet-300 dark:hover:border-violet-700 transition-colors">
            <div class="flex items-center gap-3">
              <div class="w-10 h-10 rounded-lg bg-violet-100 dark:bg-violet-900/30 flex items-center justify-center">
                <UIcon name="i-heroicons-server-stack" class="w-5 h-5 text-violet-600 dark:text-violet-400" />
              </div>
              <div>
                <h3 class="font-medium text-gray-900 dark:text-white text-sm">
                  Nostr Relays
        ...
        <div class="bg-white dark:bg-gray-900 rounded-lg">
          ...
          <div class="p-4 max-h-96 overflow-y-auto">
            ...
            <div v-else-if="terms.length === 0" class="text-center py-8 text-gray-500">
              <UIcon name="i-heroicons-calendar-days" class="w-10 h-10 mx-auto text-gray-300 mb-2" />
              <p class="text-sm">No payment terms yet</p>
            </div>
            <div v-else class="space-y-2">
              ...
              >
                <div>
                  <p class="font-medium text-gray-900 dark:text-white text-sm">{{ term.name }}</p>
                  <p class="text-xs text-gray-500">{{ term.days }} days • {{ term.description }}</p>
                </div>
      ...
      <template #content>
        <div class="bg-white dark:bg-gray-900 rounded-lg">
          ...
          <div class="p-4 space-y-4">
            ...
            <UFormField name="days" label="Days">
              <UInput v-model="termForm.days" type="number" placeholder="30" />
            </UFormField>

            <UFormField name="description" label="Description">
              <UInput v-model="termForm.description" placeholder="Payment due within 30 days" />
            </UFormField>
          </div>

          <div class="p-4 border-t border-gray-200 dark:border-gray-800 flex justify-end gap-2">
            <UButton color="neutral" variant="outline" @click="termModalOpen = false">
              Cancel
            </UButton>
