...
<template>
  <div class="min-h-screen bg-gray-950 flex flex-col justify-center py-12">
    <!-- Background Pattern -->
    <div class="absolute inset-0 overflow-hidden pointer-events-none">
      <div class="absolute -top-40 -left-40 w-80 h-80 bg-amber-500/10 rounded-full blur-3xl" />
      <div class="absolute -bottom-40 -right-40 w-80 h-80 bg-purple-500/10 rounded-full blur-3xl" />
    </div>
    ...
    <div class="relative z-10 sm:mx-auto sm:w-full sm:max-w-md px-4">
      ...
      <div class="text-center mb-8">
        ...
        <p class="mt-2 text-gray-400">Join the future of commerce</p>
      </div>
        ...
        <div class="p-6">
          ...
          <div class="relative mb-6">
            ...
            <div class="relative flex justify-center text-sm">
              <span class="px-2 bg-gray-900 text-gray-500">or create with email</span>
            </div>
          </div>
          ...
          <form @submit.prevent="handleSignUp" class="space-y-4">
              ...
              <div v-if="formData.password" class="mt-2">
                <div class="flex gap-1 mb-1">
                  <div
                    ...
                    :class="i <= passwordStrength ? passwordStrengthColor : 'bg-gray-700'"
                  />
                </div>
            ...
            <label class="flex items-start gap-3 cursor-pointer">
              ...
              <span class="text-sm text-gray-400">
                I agree to the
                <a href="#" class="text-amber-500 hover:text-amber-400">Terms of Service</a>
                and
                <a href="#" class="text-amber-500 hover:text-amber-400">Privacy Policy</a>
              </span>
            </label>
      ...
      <div class="mt-8 grid grid-cols-3 gap-4 text-center">
        <div>
          ...
          <p class="text-xs text-gray-400">Lightning Payments</p>
        </div>
        <div>
          <div class="text-2xl mb-1">🔐</div>
          <p class="text-xs text-gray-400">Non-Custodial</p>
        </div>
        <div>
          <div class="text-2xl mb-1">🌐</div>
          <p class="text-xs text-gray-400">Decentralized</p>
        </div>
      </div>
    </div>
  </div>
